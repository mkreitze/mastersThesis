...
class Fbca:
    ...
    scoredFingerprint=[]
    scoreMatrix=[]
R=100 #this is R_o^2, standard is 100
...
for a in range(neighbourMin,neighbourMax,1):
    b=0
    neighbourhoods=[]
    while b <= a:
        neighbourhoods.append((b,a-b))
        b+=1
    QUANTIFER="Neighbourhood"+str(a)
